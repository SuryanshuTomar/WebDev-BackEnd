...
// 3. concurrently - It is useful for running multiple commands in the shell or in package.json.
// 4. kill-port - It is used to kill the running port -> kill-port [PORT_NO] (kill_port 3000)
